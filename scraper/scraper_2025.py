...
# Variables
URL = "https://techsparks.yourstory.com/2025"
EVENT_YEAR = 2025
...
def scrape():
    ...
    def parse_speaker_blocks(html):
        ...
        try:
            ...
            # '.' means class
            speaker_blocks = soup.select(".ts_speaker")
    ...
    def store_speaker_list(speaker_blocks):
        ...
        for block in speaker_blocks:
            ...
            name_tag = block.select_one(".ts_speaker-title")
            desc_tag = block.select_one(".ts_speaker-desc")
